...
public class PlatLogoActivity extends Activity {
	//SwitchPreference doesPlatLogo = (R.xml.preferences);
    ...
    Intent dessertcase = null;
    Toast settingsstatus;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        prefs = PreferenceManager.getDefaultSharedPreferences(this);
        intro = prefs.getBoolean("enable_intro",true);
        dessertcase = new Intent(this, DessertCase.class);
        if(intro){
        ...
        tv.setText("Android ".toUpperCase(new Locale("en-us")) + Build.VERSION.RELEASE.toUpperCase());
       // if(animate){
        ...
        //settingsstatus = new Toast(this);
        //Log.v(PlatLogoActivity.class.getSimpleName(),String.valueOf(animate));
        //settingsstatus.setView(mContent);
        //settingsstatus.show();
        }else{
        	transferToMosaic();
        }
    }
    protected void transferToMosaic(){
        try {
